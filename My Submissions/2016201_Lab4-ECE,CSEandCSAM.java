		...
		if(flag == false){
			...
			if(chance>5){
				...
				if(chance1 <= 65){
					...
					if(dist1<dist2){
						double xx=((4+dist1)*x-4*g1.x)/(dist1);
						double yy=((4+dist1)*y-4*g1.y)/(dist1);
						xx=Math.round(xx);
						yy=Math.round(yy);
						x=xx;
						y=yy;
						...
						double xx=((4+dist2)*x-4*g1.x)/(dist2);
						double yy=((4+dist2)*y-4*g1.y)/(dist2);
						xx=Math.round(xx);
						yy=Math.round(yy);
						x=xx;
						y=yy;
			...
			if(g1.g >= this.gh1){
				...
				if(chance <= 90){
					...
					if(chance1<=50){
						double xx=((2+dist2)*x-2*g1.x)/(dist2);
						double yy=((2+dist2)*y-2*g1.y)/(dist2);
						xx=Math.round(xx);
						yy=Math.round(yy);
						x=xx;
						y=yy;
			...
			if(g2.g >= this.gh1){
				...
				if(chance <= 90){
					...
					if(chance1<=50){
						dist2=dist2-2;
						double xx=((2+dist2)*x-2*g2.x)/(dist2);
						double yy=((2+dist2)*y-2*g2.y)/(dist2);
						xx=Math.round(xx);
						yy=Math.round(yy);
						x=xx;
						y=yy;
				...
				if(chance2<=20){
					...
					double chance3=Math.random()*100+1;
					if(chance3<=70){
						double xx=((4+dist2)*x-4*g2.x)/(dist2);
						double yy=((4+dist2)*y-4*g2.y)/(dist2);
						xx=Math.round(xx);
						yy=Math.round(yy);
						x=xx;
						y=yy;
